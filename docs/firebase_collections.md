...
| 8   | `bankName`          | String        | Không    | Tên ngân hàng thụ hưởng             |
| 9   | `bankAccountNumber` | String        | Không    | Số tài khoản ngân hàng              |
| 10  | `bankAccountName`   | String        | Không    | Tên người thụ hưởng                 |
| 11  | `createdAt`         | Timestamp     | Có       | Thời điểm tạo ví (Instant)           |
| 12  | `updatedAt`         | Timestamp     | Có       | Thời điểm cập nhật gần nhất (Instant)|
